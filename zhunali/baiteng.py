...
def statues(IPlist, id):
    ...
    file3 = file('E:\\zhuanli\\' + id + "_status", 'a+')
    for line in lines:
        print line.get_text()
...
def pdf(IPlist, id):
    ...
    file3 = file('E:\\zhuanli\\' + id + "_pdf", 'a+')
    for line in lines:
...
def desc(IPlist, id):
    ...
    file3 = file('E:\\zhuanli\\' + id + "_desc", 'a+')
    for line in lines:
        print line.get_text()
...
def clms(IPlist, id):
    ...
    file2=file('E:\\zhuanli\\'+id+"_clms", 'a+')
    for line in lines:
        print line.get_text()
...
def abst(IPlist, id):
    ...
    file1 = file('E:\\zhuanli\\' + id + "_abst", 'a+')
    for line in lines:
        print line.get_text()
...
def t2(IPlist, i):
    ...
    headers['Referer'] = 'http://www.patexplorer.com/results/s.html?sc=63&q=%28ad%3A%5B19480801+TO+20170808%5D%29&fq=type%3A%28cn_in%29&type=s&sort=&sortField='
    #headers["X-Forwarded-For"] = choice(IPlist)
    data = {"sc": "63", 'q':'(ad:[20170525 TO 20170808])', \
                     'sort': '', 'sortField':'', \
                     'fq':"type:(cn_in)",'pageSize':'100', \
